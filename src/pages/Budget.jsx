                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-white rounded-2xl shadow-xl p-6 border border-gray-100">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                    <div className="bg-gradient-to-br from-purple-50 to-indigo-100 p-5 rounded-xl border border-purple-200 shadow-sm hover:shadow-md transition-shadow duration-300">
                                        ...
                                        <p className="text-3xl font-bold text-purple-600">{budgetHealth.score}<span className="text-lg">/100</span></p>
                                    ...
                                    <div className="bg-gradient-to-br from-blue-50 to-cyan-100 p-5 rounded-xl border border-blue-200 shadow-sm hover:shadow-md transition-shadow duration-300">
                                        <div className="flex items-center mb-3">
                                            ...
                                            <h3 className="font-semibold text-gray-700">On Track</h3>
                                        </div>
                                        <p className="text-3xl font-bold text-blue-600">{budgetHealth.onTrackBudgets}<span className="text-lg text-gray-500">/{budgetHealth.totalBudgets}</span></p>
                                        <p className="text-xs text-gray-500 mt-1">Budgets performing well</p>
                                    </div>
                                    <div className="bg-gradient-to-br from-green-50 to-teal-100 p-5 rounded-xl border border-green-200 shadow-sm hover:shadow-md transition-shadow duration-300">
                                        <div className="flex items-center mb-3">
                                            ...
                                            <h3 className="font-semibold text-gray-700">Total Budgeted</h3>
                                        </div>
                                        <p className="text-3xl font-bold text-green-600">${(budgetHealth.totalBudgeted / 1000).toFixed(1)}<span className="text-lg">k</span></p>
                                        <p className="text-xs text-gray-500 mt-1">Monthly allocation</p>
                                    </div>
                                    <div className="bg-gradient-to-br from-amber-50 to-yellow-100 p-5 rounded-xl border border-amber-200 shadow-sm hover:shadow-md transition-shadow duration-300">
                                        <div className="flex items-center mb-3">
                                        ...
                                        <p className="text-3xl font-bold text-amber-600">${(budgetHealth.totalSpent / 1000).toFixed(1)}<span className="text-lg">k</span></p>
                            ...
                            <div className="bg-white rounded-2xl shadow-xl p-6 border border-gray-100">
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                    <div className="h-80 min-h-80 bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-4 border border-gray-200">
                                        <h3 className="text-lg font-semibold text-gray-700 mb-4 text-center">Budget vs Spending Comparison</h3>
                                        <ResponsiveContainer width="100%" height="100%" minWidth={0} minHeight={0}>
                                            <BarChart data={chartData} margin={{ top: 20, right: 30, left: 20, bottom: 60 }}>
                                                ...
                                                />
                                                <Bar dataKey="budgeted" fill="#818cf8" name="Budgeted" radius={[4, 4, 0, 0]}>
                                                ...
                                                <Bar dataKey="spent" fill="#34d399" name="Spent" radius={[4, 4, 0, 0]} />
                                            </BarChart>
                                        </ResponsiveContainer>
                                    </div>
                                    <div className="h-80 min-h-80 bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-4 border border-gray-200">
                                        <h3 className="text-lg font-semibold text-gray-700 mb-4 text-center">Spending Distribution</h3>
                                        <ResponsiveContainer width="100%" height="100%" minWidth={0} minHeight={0}>
                                            <PieChart>
                                                <Pie
                                                    data={chartData}
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                                    ...
                                    <div className="flex items-end">
                                        <button
                                            ...
                                            className="w-full px-4 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg hover:from-indigo-700 hover:to-purple-700 transition-all duration-300 transform hover:-translate-y-0.5 shadow-md hover:shadow-lg flex items-center justify-center"
                                        >
                                ...
                                <div className="space-y-5">
                                    {budgetData.length > 0 ? (
                                        budgetData.map(budget => (
                                            <div key={budget.id} className="border border-gray-200 rounded-xl p-5 hover:shadow-md transition-shadow duration-300 bg-gradient-to-br from-white to-gray-50">
                                                <div className="flex justify-between items-start mb-4">
                                                    <div>
                                                        <h3 className="font-bold text-lg text-gray-800">{budget.categoryName}</h3>
                                                        <div className="flex items-center mt-1">
                                                            ...
                                                            <span className="ml-2 text-sm text-gray-500">{budget.progress.percentage}% used</span>
                                                        </div>
                                                    </div>
                                                    <button
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                                    <div className="bg-indigo-50 p-3 rounded-lg border border-indigo-100">
                                                        <p className="text-xs text-indigo-600 font-medium">Budgeted</p>
                                                        <p className="font-bold text-indigo-700">${budget.amount.toFixed(2)}</p>
                                                    </div>
                                                    <div className="bg-emerald-50 p-3 rounded-lg border border-emerald-100">
                                                        <p className="text-xs text-emerald-600 font-medium">Spent</p>
                                                        <p className="font-bold text-emerald-700">${budget.spent.toFixed(2)}</p>
                                                    </div>
                                                    <div className={`p-3 rounded-lg border ${budget.progress.remaining < 0 ? 'bg-red-50 border-red-100' : 'bg-amber-50 border-amber-100'}`}>
                                                        <p className="text-xs font-medium" style={{ color: budget.progress.remaining < 0 ? '#dc2626' : '#d97706' }}>
                                                            {budget.progress.remaining < 0 ? 'Over by' : 'Remaining'}
                                                        </p>
                                                        <p className="font-bold" style={{ color: budget.progress.remaining < 0 ? '#dc2626' : '#d97706' }}>
                                        ...
                                        <div className="text-center py-12 bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl border-2 border-dashed border-gray-200">
                                            ...
                                            <h3 className="text-lg font-medium text-gray-700 mb-2">No budgets yet</h3>
                                ...
                                {budgetAlerts.length > 0 ? (
                                    <div className="space-y-4">
                                        {budgetAlerts.map((alert, index) => (
                                            <div 
                                                key={index} 
                                                className={`p-5 rounded-xl border-l-4 shadow-sm hover:shadow-md transition-shadow duration-300 ${
                                                ...
                                                <div className="flex justify-between items-start">
                                                    <div className="flex items-start">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-sm text-gray-600 mt-1">Take action to avoid overspending in this category.</p>
                                                        </div>
                                                    </div>
                                    ...
                                    <div className="text-center py-12 bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl border border-green-200">
                                        ...
                                        <h3 className="text-lg font-medium text-gray-700 mb-2">All budgets are on track!</h3>
                                        <p className="text-gray-500">Great job managing your finances. No alerts at this time.</p>
                                    </div>
                                )}
                            </div>
                                ...
                                {budgetSuggestions.length > 0 ? (
                                    <div className="space-y-4">
                                        {budgetSuggestions.map((suggestion, index) => (
                                            <div key={index} className="border border-gray-200 rounded-xl p-5 hover:shadow-md transition-shadow duration-300 bg-gradient-to-br from-white to-gray-50">
                                                <div className="flex justify-between items-start mb-4">
                                                    <div>
                                                        <h3 className="font-bold text-lg text-gray-800">{suggestion.categoryName}</h3>
                                                        <div className="flex items-center mt-1">
                                                            <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                                                    ...
                                                    <div className={`p-3 rounded-lg ${
                                                        ...
                                                        <p className={`font-bold ${suggestion.difference > 0 ? 'text-red-600' : 'text-green-600'}`}>
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                                    <div className="bg-indigo-50 p-3 rounded-lg border border-indigo-100">
                                                        <p className="text-xs text-indigo-600 font-medium">Current Budget</p>
                                                        <p className="font-bold text-indigo-700">${suggestion.currentBudget.toFixed(2)}</p>
                                                    </div>
                                                    <div className="bg-blue-50 p-3 rounded-lg border border-blue-100">
                                                        <p className="text-xs text-blue-600 font-medium">Suggested Budget</p>
                                                        <p className="font-bold text-blue-700">${suggestion.suggestedBudget.toFixed(2)}</p>
                                                    </div>
                                                    <div className="bg-amber-50 p-3 rounded-lg border border-amber-100">
                                                        <p className="text-xs text-amber-600 font-medium">Change Required</p>
                                                        <p className="font-bold text-amber-700">{Math.abs(suggestion.percentageChange)}%</p>
                                                    </div>
                                                </div>
                                    ...
                                    <div className="text-center py-12 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border border-blue-200">
                                        ...
                                        <h3 className="text-lg font-medium text-gray-700 mb-2">No suggestions at this time</h3>
                                        <p className="text-gray-500">Your budgets are well-aligned with your spending patterns.</p>
                                    </div>
                                )}
                            </div>
                        </div>
