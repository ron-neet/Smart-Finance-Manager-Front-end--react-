...
import { LoaderCircle, Eye, EyeOff, User, Mail, Lock, WalletCards, Facebook, Twitter, Instagram } from "lucide-react";
    ...
    return (
        <div className="min-h-screen w-full relative flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-lg px-6">
                <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20 hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-2">
                    <div className="text-center mb-8">
                        <div className="mx-auto w-20 h-20 bg-gradient-to-br from-purple-600 via-purple-500 to-indigo-600 rounded-2xl flex items-center justify-center mb-4 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
