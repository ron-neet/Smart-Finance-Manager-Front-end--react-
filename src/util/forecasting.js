 ...
 * @param {Array} x - Independent variables (time indices)
 * @param {Array} y - Dependent variables (amounts)
 ...
 * @returns {Array} Filtered transactions from the last 12 months
 */
 ...
 * @returns {Object} Trend information with slope, intercept, R-squared, and direction
 */
 ...
 * @returns {Array} Monthly savings projections with confidence intervals
 */
